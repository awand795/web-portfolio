                ...
                <FadeInWhenVisible>
                    ...
                    <div className="row pt-3 pb-3">
                        <div className="col-sm-6 mx-auto ml-auto">
                            <p className="text-justify lh-lg">I'm a Fullstack Javascript Enthusiast focusing on MERN Stack Web Development, I exprienced for building website using React for Frontend and Express for Backend. I'm also a student in STMIK Kaputama</p>
                        </div>
                ...
                <FadeInWhenVisible>
                    ...
                    <div className="row justify-content-center pt-3">
                        ...
                        <div className="col-sm-4 mt-auto mb-5">
                            ...
                            <a href="https://instagram.com/awandd83">
