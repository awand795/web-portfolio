                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Simple Notes App build on Vue JS and backend using express</p>
                            </div>
                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Laravel 8 Restfull API With Passport for authentication</p>
                            </div>
                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Simple web app for see statistic covid-19</p>
                            </div>
                            <div className="d-flex justify-content-between card-body mt-auto">
                                <span className="bi-github"></span> 
                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Simple RestfulAPI using Express JS</p>
                            </div>
                            <div className="card-body mt-auto d-flex justify-content-between">
                                <span className="bi-github"></span> 
                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Simple Login With JWT auth using Express JS and MongoDB.</p>
                            </div>
                            <div className="d-flex justify-content-between card-body mt-auto">
                                <span className="bi-github"></span> 
                    ...
                    >
                        <div className="card shadow flex-fill">
                            <div className="card-body">
                                ...
                                <p className="card-subtitle mb-5 text-muted mt-3">Simple CRUD Website using React</p>
                            </div>
                            <div className="d-flex justify-content-between card-body mt-auto">
                                <span className="bi-github"></span> 
